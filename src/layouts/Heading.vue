<template>
  <div
    class="bg-gray-900 py-3 px-6 shadow-2 flex align-items-center justify-content-between relative lg:static border-bottom-1 border-gray-800"
    style="min-height: 84px"
  >
    <img
      src="images/blocks/logos/bastion-300.svg"
      alt="Image"
      height="40"
      class="mr-0 lg:mr-6"
    />
    <a
      v-ripple
      class="cursor-pointer block lg:hidden text-gray-400 mt-1 p-ripple"
      v-styleclass="{
        selector: '@next',
        enterClass: 'hidden',
        leaveToClass: 'hidden',
    ...
    >
      ...
      >
        ...
        <li class="border-top-1 border-gray-800 lg:border-top-none">
          <a
            v-ripple
            class="flex px-6 p-3 lg:px-3 lg:py-2 align-items-center hover:bg-gray-800 font-medium border-round cursor-pointer transition-colors transition-duration-150 p-ripple"
          >
            <img
